...
function initProductListing(currentCategory) {
  ...
  function loadCards() {
    ...
    if (loadedCards >= filteredProducts.length) { // Используем filteredProducts
...
// Экспортируем функцию initProductListing
export { initProductListing }; 
